  ...
  <view>
    ...
    <view style="padding: 0 0.65rem">
      ...
      <u-search
          ...
          @search="getCheckInHeritageList" @clear="getCheckInHeritageList"></u-search>
      <!-- 搜索区域 -->
    ...
    <view class="list-area" style="margin-top: 10px;padding: 0 0.65rem">
      ...
      >
        <u-list-item
            v-for="(country, countryIndex) in countryHeritageList"
            :key="countryIndex"
        >
          <view>
...
<!--                  </view>-->
<!--                </u-col>-->
<!--                <u-col span="9.5" style="height: 70px">-->
<!--                  <u-row>-->
...
<!--                        <svg v-if="heritage.category === 'Cultural'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<!--                        <svg v-if="heritage.category === 'Natural'" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<!--                        <svg v-if="heritage.category === 'Mixed'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
export default {
  ...
  methods: {
    ...
    getCheckInHeritageList()  {
      uni.showLoading({
        title: 'Loading'
      });
      getMyCheckInHeritage({ custom: { auth: true}, params: this.listQuery}).then((response) => {
        this.countryHeritageList = response.data.user_check_in_list
        this.indexList = response.data.letters
        uni.hideLoading()
      }).catch((error) => {
        uni.hideLoading()
      })
